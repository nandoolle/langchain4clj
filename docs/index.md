...
```clojure
{:deps {io.github.nandoolle/langchain4clj {:mvn/version "1.6.0"}}}
```

Or to your Leiningen `project.clj`:

```clojure
[io.github.nandoolle/langchain4clj "1.6.0"]
```
...
- **[Clojars](https://clojars.org/io.github.nandoolle/langchain4clj)** - Download and dependency information
